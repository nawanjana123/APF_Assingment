...
Research researchObj = new Research();
	...
	@FormParam("R_Budget") String Budget)
	{
		 String output = researchObj.insertData(ResearchName, Author1, Author2, Author3, ResearchField, Publisher, PublishYear, Budget);
		return output;
		}
	@PUT
	@Path("/")
	...
	//Read the values from the JSON object
	 ...
	 String Budget = researchObject.get("R_Budget").getAsString();
	 
	
	 String output = researchObj.updateData(ResearchID,ResearchName, Author1, Author2, Author3, ResearchField, Publisher, PublishYear, Budget);
		return output;
		}
